...
const Departments: React.FC = () => {
  ...
  const [itemToDelete, setItemToDelete] = useState<DepartmentType | null>(null);

  const handleEdit = (department: DepartmentType) => {
    navigate(`/departamentos/editar/${department._id}`);
  };
      ...
      <div className="w-full p-8 bg-white rounded shadow-md">
        <div className="flex justify-between items-center mb-6 border-b pb-4 border-gray-400">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-700">Departamentos</h1>
          </div>
          <Link
